...
//  var $usernameDiv = $('<div class="chat-avatar"><span class="name">{0}</span><i class="icon-ninja-face" style="color:{0}"></i></div>'.format(data.username).format(rgbColor));
...
//var $usernameDiv = $('<div class="chat-avatar"><span class="name">{0}</span><i class="icon-ninja-face"></i></div>'.format(data.username));

var $messageTextDiv = $('<div class="msg-text"><p>{0}</p></div>'.format(data.message)).addClass('balloon');

var $messageDateDiv = $('<div class="msg-date"><div class="date">{0}</div></div>'.format(dt.getHours()+ ':' + dt.getMinutes()));
